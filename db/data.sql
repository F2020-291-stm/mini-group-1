-- Data prepared by Giancarlo Pernudi Segura, pernudi@ualberta.ca, published on 29/09/2020
PRAGMA foreign_keys = ON;

insert into users values ('u001','Richard Sutton', 'Edmonton', '2018-01-05');
insert into users values ('u002','Adam White', 'Edmonton', '2018-06-02');
insert into users values ('u003','Alan Turing', 'London', '2018-02-18');
insert into users values ('u004','Linus Torvalds', 'Helsinki', '2018-10-20');
insert into users values ('u005','Richard Stallman', 'New york', '2018-12-31');
insert into users values ('u006', 'Bjarne Stroustrup', 'New York', '2019-01-01');
insert into users values ('u007', 'Ken Thompson', 'New Orleans', '2018-10-10');
insert into users values ('u008', 'Tom Lane', 'Madrid', '2018-11-30');
insert into users values ('u009', 'Dennis Ritchie', 'Bronxville', '2018-03-12');
insert into users values ('u010', 'Michael Stonebraker', 'Newburyport', '2018-09-11');
...
insert into ubadges values ('u007', '2020-08-19', 'mediocre answer');
...
insert into ubadges values ('u005', '2020-09-23', 'intriguing question');
